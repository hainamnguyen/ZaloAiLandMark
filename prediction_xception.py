...
model.load_weights('weights_trained/xception.h5', by_name=True)
...
np.savez('result/xception.npz', predicts_nohot=predicts_nohot)
...
w = csv.writer(open("result_exception.csv", "w"))
