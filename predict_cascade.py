...
result_exception = np.load('result/private_xception.npz')
result_exception = result_exception['predicts_nohot']

result_inceptionresnet = np.load('result/private_inceptionresnet.npz')
result_inceptionresnet = result_inceptionresnet['predicts_nohot']

result_resnet101 = np.load('result/private_resnet101.npz')
result_resnet101 = result_resnet101['predicts_nohot']

result_resnet50 = np.load('result/private_resnet50.npz')
...
test_generator = test_datagen.flow_from_directory('/home/phoenix/Hana/challenge/private/',
        target_size=(480, 480),
        shuffle = False,
...
w = csv.writer(open("result/private_finalresult.csv", "w"))
