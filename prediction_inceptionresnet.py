...
model.load_weights('weights_trained/inception_resnet.h5', by_name=True)
...
np.savez('result/inception_resnet.npz', predicts_nohot=predicts_nohot)
...
w = csv.writer(open("result_inceptionresnet.csv", "w"))
