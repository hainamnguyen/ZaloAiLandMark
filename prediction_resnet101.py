...
model.load_weights('weights_trained/resnet101.h5', by_name=True)
...
np.savez('result/resnet101.npz', predicts_nohot=predicts_nohot)
...
w = csv.writer(open("result_resnet101.csv", "w"))
